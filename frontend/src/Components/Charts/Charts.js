...
class PurchaseDistributionByDates extends Component {
  ...
  generateBarChartData(initialDate = false, finalDate = false, numberOfIntervals = 10) {
  ...
  render() {
    ...
    return <ChartWithOptions title="Compras por fecha" generateBarChartData={this.generateBarChartData} renderId={this.props.renderId} showPartsOption={true} />
  }
}
